...
require (
	...
	kmodules.xyz/resource-metadata v0.18.3-0.20240402213651-c2066155d5e3
...
replace helm.sh/helm/v3 => github.com/x-helm/helm/v3 v3.14.4-0.20240324190704-bf69fbd1157c
